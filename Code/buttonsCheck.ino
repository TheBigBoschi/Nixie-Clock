...
// This file contains the button check routines. It also implements a pressing-repeat function if a button is being held (just for + and -)
...
//Static variables, they keep their value between function calls. They store the time at which the button was last pressed, used for the repeat function.
